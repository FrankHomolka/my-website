...
import hometeamMedia1Mobile from "../Media/hometeam_job_mobile.jpg";
import hometeamMedia2 from "../Media/hometeam_provider.jpg";
import hometeamMedia2Mobile from "../Media/hometeam_provider_mobile.jpg";
    ...
    >
      ...
      {location.pathname === "/projects/hometeam" && (
        <ProjectDetails
          ...
          description={[
            ...
            windowSize.mobile ? hometeamMedia1Mobile : hometeamMedia1,
            ...
            "After making significant strides towards creating a full featured web app, we realized we needed to refactor a large portion of the codebase, ",
            "and as we were adding more complex features like Google Maps integration and image editing, we decided to recreate the prototype using React.js and Typescript. ",
            "This allowed us to create a more robust foundation that focused heavily on extracting features into reusable components, which drastically decreased ",
            "the time required to implement new features. ",
            windowSize.mobile ? hometeamMedia2Mobile : hometeamMedia2,
            ...
            "researching and incorporating external libraries. ",
            "I was in charge of the majority of the webpages and functionality of HomeTeam, except most of the Google Maps integration which was handled by my co-worker. ",
            ...
            "using good design practices, and working on a small team. ",
          ]}
          dateCreated={"January 20th, 2021"}
      ...
      {location.pathname === "/projects/tour-selma" && (
        <ProjectDetails
          ...
          description={[
            ...
            "a custom map, and connect the pins to create a path. ",
            "After my internship was over the other developers at MotionMobs implemented the remaining content (audio clips, images, and pins), ",
      ...
      {location.pathname === "/projects/repose" && (
        <ProjectDetails
          ...
          description={[
            ...
            "You can download 'Repose' through the link in the title above. ",
          ]}
      ...
      {location.pathname === "/projects/flower-knight" && (
        <ProjectDetails
          ...
          description={[
            ...
            "This requires you to fight through throngs of enemies, collect gold, unlock and buy items, and die over and over again until you're strong enough ",
            "to defeat the king and escape to the overworld. ",
            "It was the first video game I ever completed, and I did all of the game design, art creation (except for some character design and pixel art by Perrin Heasley), ",
            ...
            "Flower Knight is available for download through the link in the title above. ",
          ]}
      ...
      {location.pathname === "/projects/this-website" && (
        <ProjectDetails
          title={"This Website"}
          description={[
            "I created this website using React.js, TypeScript, HTML, and CSS. ",
            ...
            "For this reason, animations and transitions are fast and used sparingly, and all website elements are black and white to highlight the content of each page. ",
            ...
            "The website is divided into three sections, 'Home', an introduction to who I am, ",
            " 'Coding', which showcases some of the projects I've worked on, and 'Music' which displays some of the ",
            "albums I've released. This structural division is a reflection of who I am as a person, equally interested in technology ",
            "and programming, and in creativity and humanity. ",
          ]}
